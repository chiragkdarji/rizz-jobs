...
const CATEGORY_NAME = "Admit Cards";
const CATEGORY_DESCRIPTION = "Admit Card Releases & Exam News";
const CATEGORY_TAGLINE =
  "Stay ready for your exams. Get instant admit card and exam notification alerts.";

export const metadata: Metadata = {
  title: `${CATEGORY_NAME} Jobs - Admit Card Notifications | Rizz Jobs`,
  description: `Latest admit card releases and exam news. Get instant notifications for admit card releases and exam information.`,
  keywords: ["admit cards", "exam news", "admit card releases"],
};
...
async function getTextFilterNotifications(
  filterText: string,
  searchQuery: string,
  page: number
...
async function getCategoryNotifications(
  ...
  return getTextFilterNotifications(filterText, searchQuery, page);
}
