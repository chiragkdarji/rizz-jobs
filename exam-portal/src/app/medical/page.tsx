...
export default function Home() {
  ...
  const [activeTab] = useState("Medical");
  ...
  const filtered = notifications.filter(n => {
    ...
    if (activeTab !== "All") {
      ...
      if (activeTab === "Medical" && (text.includes("medical") || text.includes("nurse") || text.includes("doctor") || text.includes("mbbs") || text.includes("hospital") || text.includes("aiims") || text.includes("nursing") || text.includes("health"))) return true;
    }
          ...
          >
            <div className="w-full lg:w-[100%]">
              ...
              <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-6 leading-[0.9] italic">
                Top <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-indigo-500 to-purple-600 drop-shadow-[0_0_30px_rgba(99,102,241,0.3)] pr-3 pl-1" style={{ WebkitBoxDecorationBreak: "clone" }}>Medical & Healthcare </span> Jobs.
              </h1>
              <p className="text-xl text-gray-400 leading-relaxed font-medium w-full lg:max-w-3xl">
                Government hospital vacancies, AIIMS, and state medical officer recruitment.
              </p>
            </div>
