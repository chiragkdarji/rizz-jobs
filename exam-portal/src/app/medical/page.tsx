...
const CATEGORY_DESCRIPTION = "Medical Job Notifications & Healthcare Recruitment";
const CATEGORY_TAGLINE =
  "Healthcare careers await. Get AIIMS, medical institute, and healthcare recruitment notifications.";

export const metadata: Metadata = {
  title: `${CATEGORY_NAME} Jobs - Medical Job Notifications | Rizz Jobs`,
  description: `Latest medical job notifications including AIIMS, medical institute, and healthcare recruitment. Get all medical exam alerts.`,
  keywords: ["medical jobs", "AIIMS", "healthcare recruitment", "doctor jobs"],
};
