...
const CATEGORY_NAME = "Banking";
const CATEGORY_DESCRIPTION = "Bank Job Notifications & Exam Updates";
const CATEGORY_TAGLINE =
  "Stay ahead in banking recruitment. Get IBPS, SBI, and other bank job notifications instantly.";

export const metadata: Metadata = {
  title: `${CATEGORY_NAME} Jobs - Bank Exam Notifications | Rizz Jobs`,
  description: `Latest bank job notifications including IBPS PO, IBPS Clerk, SBI PO, and more. Get all banking recruitment alerts and exam dates.`,
  keywords: ["bank jobs", "IBPS", "SBI", "PO", "Clerk", "banking exam", "RBI"],
};
