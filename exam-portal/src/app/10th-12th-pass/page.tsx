...
const CATEGORY_NAME = "10th / 12th Pass";
const CATEGORY_DESCRIPTION = "Entry-Level Job Notifications";
const CATEGORY_TAGLINE =
  "Start your career early. Get job notifications for candidates.";

export const metadata: Metadata = {
  title: `${CATEGORY_NAME} Jobs - 10th Bank Exam Notifications 12th Pass Jobs | Rizz Jobs`,
  description: `Latest job notifications for candidates. Get entry-level job opportunities and recruitment alerts.`,
  keywords: ["10th pass jobs", "12th pass jobs", "entry-level jobs"],
};
