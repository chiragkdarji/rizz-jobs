...
const CATEGORY_NAME = "PSU";
const CATEGORY_DESCRIPTION = "PSU Job Notifications & Public Sector Recruitment";
const CATEGORY_TAGLINE =
  "Work in leading enterprises. Get all PSU and public sector recruitment alerts.";

export const metadata: Metadata = {
  title: `${CATEGORY_NAME} Jobs - PSU Job Notifications | Rizz Jobs`,
  description: `Latest PSU job notifications including public sector recruitment and government enterprise jobs. Get all PSU exam alerts.`,
  keywords: ["PSU jobs", "public sector recruitment", "government jobs", "enterprise jobs"],
};
