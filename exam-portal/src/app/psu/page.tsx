...
export default function Home() {
  ...
  const filtered = notifications.filter(n => {
    ...
    if (activeTab !== "All") {
      ...
      if (activeTab === "PSU" && (text.includes("psu") || text.includes("ntpc") || text.includes("iocl") || text.includes("bhel") || text.includes("sail") || text.includes("gail") || text.includes("ongc") || text.includes("hal "))) return true;
    }
          ...
          >
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-6 leading-[0.9] italic">
                Lucrative <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-indigo-500 to-purple-600 drop-shadow-[0_0_30px_rgba(99,102,241,0.3)] pr-3 pl-1" style={{ WebkitBoxDecorationBreak: "clone" }}>PSU Jobs </span> Available Now.
              </h1>
              <p className="text-xl text-gray-400 leading-relaxed font-medium max-w-xl">
                Navratna, Maharatna, and Miniratna job updates. Power up your career in public sector undertakings.
              </p>
            </div>
