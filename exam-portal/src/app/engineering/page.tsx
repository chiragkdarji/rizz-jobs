...
const CATEGORY_DESCRIPTION = "Engineering Job Notifications & Recruitment";
const CATEGORY_TAGLINE =
  "Build your career in engineering. Get PSU, ISRO, DRDO, and tech recruitment alerts.";

export const metadata: Metadata = {
  title: `${CATEGORY_NAME} Jobs - Engineering Job Notifications | Rizz Jobs`,
  description: `Latest engineering job notifications including PSU, ISRO, DRDO, and tech company recruitment. Get all engineering exam alerts.`,
  keywords: ["engineering jobs", "PSU recruitment", "ISRO", "DRDO", "tech jobs"],
};
