...
const CATEGORY_NAME = "Teaching";
const CATEGORY_DESCRIPTION = "Teaching Job Notifications & Exam Updates";
const CATEGORY_TAGLINE =
  "Shape the future. Get all teacher recruitment and educational institution notifications.";

export const metadata: Metadata = {
  title: `${CATEGORY_NAME} Jobs - Teaching Job Notifications | Rizz Jobs`,
  description: `Latest teaching job notifications including teacher recruitment, educational institution jobs, and school notifications.`,
  keywords: ["teaching jobs", "teacher recruitment", "school jobs", "educational jobs"],
};
