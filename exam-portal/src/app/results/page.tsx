...
const CATEGORY_DESCRIPTION = "Exam Results & Merit Lists";
const CATEGORY_TAGLINE =
  "Check your success. Get instant exam results and merit list notifications.";

export const metadata: Metadata = {
  title: `${CATEGORY_NAME} Jobs - Exam Results & Merit Lists | Rizz Jobs`,
  description: `Latest exam results and merit lists. Get instant notifications for exam results and merit list releases.`,
  keywords: ["exam results", "merit lists", "result notifications"],
};
