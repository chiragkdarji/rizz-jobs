...
const CATEGORY_NAME = "Railway";
const CATEGORY_DESCRIPTION = "Railway Job Notifications & Recruitment Updates";
const CATEGORY_TAGLINE =
  "Never miss a Railway recruitment. Get instant notifications for RRB and Railway Ministry jobs.";

export const metadata: Metadata = {
  title: `${CATEGORY_NAME} Jobs - Railway Exam Notifications | Rizz Jobs`,
  description: `Latest railway job notifications including RRB exams, Railway Ministry jobs, and recruitment updates. Get all railway exam alerts and deadlines.`,
  keywords: ["railway jobs", "RRB", "railway recruitment", "RRB exam", "railway ministry"],
};
