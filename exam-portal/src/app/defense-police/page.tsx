...
const CATEGORY_NAME = "Defense / Police";
const CATEGORY_DESCRIPTION = "Defense & Police Job Notifications";
const CATEGORY_TAGLINE =
  "Serve your nation. Get all defense, police, and armed forces recruitment notifications.";

export const metadata: Metadata = {
  title: `${CATEGORY_NAME} Jobs - Defense & Police Exam Notifications | Rizz Jobs`,
  description: `Latest defense and police job notifications including armed forces, paramilitary, and police recruitment. Get all defense recruitment alerts.`,
  keywords: ["defense jobs", "police jobs", "armed forces", "paramilitary recruitment"],
};
